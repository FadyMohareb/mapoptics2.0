 ...
 *
 * @author franpeters
 * The purpose of this class is to save all of the information of a submitted job allowing the data
 * to be downloaded from the server it was run on and display the results for the user.
 * 
 */
public class Job {
    private String name;
     ...
     * @param qOrg query organism species (genus and species required i.e. Homo sapiens)
     * @param rOrg reference organism species (genus and species required i.e. Homo sapiens)
     * @param rAnnot file path to the GTF or GFF3 annotation file for reference genome
     * @param qAnnot file path to the GTF or GFF3 annotation file for query genome
     */
    ...
    /**
     * 
     * @param server set the ExternalServer of that the job is running on. To be used when querying the status of the job
     */
    ...
    /**
     * 
     * @param enzyme set the Enzyme object used to digest the reference and query fasta files
     */
    ...
    /**
     * 
     * @param status set the latest status of the job from querying the log file associated with the job
     */
    ...
    /**
     * 
     * @param org set the reference species, including the genus name i.e. Homo sapiens. For use when querying databases
     */
    ...
    /**
     * 
     * @param org Set the query species, including the genus name i.e. Homo sapiens. For use when querying databases
     */
    ...
    /**
     * 
     * @param annot Set the filepath of the reference GTF or GFF file for the reference genome
     */
    ...
    /**
     * 
     * @param annot Set the filepath of the reference GTF or GFF file for the query genome
     */
