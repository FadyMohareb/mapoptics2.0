 ...
 *
 * @author franpeters
 * To draw the alignment to the panel like this:
 * _________
 * |       |
 * |       |
 * |       |
 * |-------|      
 * |-------|
 * Where the lines to join the alignment are anchored to the site positions on the reference and the query
 * can be moved about, with the alignment lines following
 */
